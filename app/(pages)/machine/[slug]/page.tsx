...
export default async function MachinePage({ params }: MachinePageProps) {
  ...
  return (
    <PageLayout className='min-h-screen bg-black p-4 text-white md:p-0 lg:p-0'>
      {/* Parent Grid: 12-column layout */}
      <section className='mx-auto flex flex-col gap-6 sm:w-5xl lg:col-span-8'>
        <div className='relative h-96 overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900'>
          <Image
            src={imageUrl}
            alt={imageAlt}
            fill
